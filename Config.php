...
class Config
{
    const TABLE_SQLS = [
        ...
        ProductAbstract::class => "CREATE TABLE IF NOT EXISTS Products (id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT, name VARCHAR(40), cost VARCHAR(20), manufacture VARCHAR(40), date VARCHAR(30), service FOREIGN KEY REFERENCES Services(name), user_id FOREIGN KEY REFERENCES Users(email), product VARCHAR(30))"
    ];
}